//===--- builtin_with_mapping.h - test input file for iwyu ----------------===//
//
...
#ifndef INCLUDE_WHAT_YOU_USE_TESTS_CXX_BUILTIN_WITH_MAPPING_H_
#define INCLUDE_WHAT_YOU_USE_TESTS_CXX_BUILTIN_WITH_MAPPING_H_
...
#endif  // INCLUDE_WHAT_YOU_USE_TESTS_CXX_BUILTIN_WITH_MAPPING_H_

/**** IWYU_SUMMARY

(tests/cxx/builtin_with_mapping.h has correct #includes/fwd-decls)
